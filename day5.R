...
arg%>%
  filter(indice_tiempo>=lubridate::ymd("2015-12-10"))%>%
  #Agregar nombres de presidentes
  mutate(pres=ifelse(indice_tiempo>=lubridate::ymd("2015-12-10") & 
                       indice_tiempo<=lubridate::ymd("2019-12-10"), 
  ...
  labs(
    title = "Argentina. Tipo de cambio diario, 2015-2021",
...
##Salvar el gráfico
ggsave("day5.png",height = 10,width = 30, units="in",dpi=300)